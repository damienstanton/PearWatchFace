...
class WatchFaceService : CanvasWatchFaceService() {
    ...
    private inner class Engine : CanvasWatchFaceService.Engine() {
        ...
        private var mColorTicksModule: ColorTicksModule? = null
        ...
        fun onCreate(holder: SurfaceHolder) {
            ...
            mColorTicksModule = ColorTicksModule()
            ...
            val color = mPrefs!!.getInt("settings_color_color_value", Color.parseColor("#00BCD4"))
            val accentColor = mPrefs!!.getInt("settings_color_accent_color_value",
        ...
        fun onDraw(canvas: Canvas, bounds: Rect) {
            ...
            when (SETTINGS_MODE) {
                ...
                3 -> {
                    setBounds()
                    val color = mPrefs!!.getInt("settings_color_color_value",

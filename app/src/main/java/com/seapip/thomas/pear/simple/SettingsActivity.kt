        ...
        adapter = object : SettingsAdapter(getFragmentManager()) {
            ...
            fun initPages(): ArrayList<SettingsRow> {
                ...
                styleOverlay.setRunnable(object : Runnable() {
                    @Override
                    fun run() {
                        var style = preferences.getInt("settings_simple_style", 0)
                        style++
